...
# Form implementation generated from reading ui file 'dockcbers4adownloader.ui'
#
...
class Ui_DockCbers4aDownloader(object):
    def setupUi(self, DockCbers4aDownloader):
        ...
        DockCbers4aDownloader.setMinimumSize(QtCore.QSize(360, 46))
        ...
        self.assetsList = QtWidgets.QListWidget(self.preview)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.assetsList.sizePolicy().hasHeightForWidth())
        self.assetsList.setSizePolicy(sizePolicy)
        self.assetsList.setMaximumSize(QtCore.QSize(16777215, 60))
        self.assetsList.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.assetsList.setFrameShadow(QtWidgets.QFrame.Plain)
        self.assetsList.setSelectionMode(QtWidgets.QAbstractItemView.MultiSelection)
        self.assetsList.setViewMode(QtWidgets.QListView.IconMode)
